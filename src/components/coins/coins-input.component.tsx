...
export type CoinsInputProps = PrimitiveInputProps

export default function CoinsInput({ className, ...props }: CoinsInputProps) {
  return (
...
export function CoinsInputGroup({ className, ...props }: GroupProps) {
  return (
    <Group
      data-slot="control"
      className={cx(
